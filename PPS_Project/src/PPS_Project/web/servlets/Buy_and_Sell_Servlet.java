...
public class Buy_and_Sell_Servlet extends HttpServlet {
	...
	private void buyPPS(HttpServletRequest request, HttpServletResponse response) 
		...
		try {
			long pps_buy_amount = Integer.parseInt(request.getParameter("PPS-to-buy-amount"));
			System.out.println("requested pps amount");
			System.out.println(pps_buy_amount);
			...
			System.out.println("requested user dollar balance");
			System.out.println(user_dollar_balance);
			...
			System.out.println("root pps amount");
			System.out.println(root_PPS_balance);
			
			PPS_Price PPS_price = PPS_PriceDAO.getLastest_PPS_price();
			
			double currentPPS_price = PPS_price.getPrice();
			System.out.println("current pps price");
			System.out.println(currentPPS_price);
			 
			double required_dollar_amount= (double)pps_buy_amount * currentPPS_price;
			System.out.println("required dollar to buy pps");
			System.out.println(required_dollar_amount);
			
			
			double updated_pps_price= 1/((1/currentPPS_price)-1);
			System.out.println("updated pps price");
			System.out.println(updated_pps_price);
			
			long updated_root_pps_balance=root_PPS_balance-pps_buy_amount;
			System.out.println("root updated pps balance");
			System.out.println(updated_root_pps_balance);
			
			double updated_root_dollar_balance=root_dollar_amount+required_dollar_amount;
			System.out.println("root updated dollar balance");
			System.out.println(updated_root_dollar_balance);
			
			
			long updated_user_pps_balance=user_pps_balance +pps_buy_amount;
			System.out.println("buyer updated pps balance");
			System.out.println(updated_user_pps_balance);
			
			double updated_user_dollar_balance=user_dollar_balance-required_dollar_amount;
			
			System.out.println("buyer updated dollar balance");
			System.out.println(updated_user_dollar_balance);
...
//update buyer info
	...
	private void sellPPS(HttpServletRequest request, HttpServletResponse response) 
		...
		try {
			...
			long PPS_Amount = Integer.parseInt(request.getParameter("PPS-to-sell-amount"));
